...
export class ProductCard {
  ...
  attachEventListeners () {
    ...
    const sizeBtns = this.el.querySelectorAll('.product-block__button-block .product-block__button')
    ...
    const flavorBtns = this.el.querySelectorAll('.product-block__flavor .product-block__button')
    ...
    addToCart.onclick = () => {
      let features = []
      const btns = this.el.querySelectorAll('.product-block__button')
